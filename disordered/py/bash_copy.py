...
# webrtc的源码目录
webrtc_source = "/home/peak/develop/sources/webrtc/src"

# 编译输出目录
webrtc_out = webrtc_source + "/out"
...
# 复制头文件
for root,dirs,files in os.walk(webrtc_source): # 完全路径, 这个文件夹中所有目录的名字, 这个文件夹中所有文件的名字
    for name in files:
        #print name
        if name.endswith(".h"):
