...
class CThreadTimer
{
  public:
	...
	CThreadTimer(CTimerManager *o, uint32_t i = 0, Func f = 0, ETimerType t = TIMER_ONCE, void *data = NULL) : powner_(o), dwinterval_(i), entype_(t), status_(WAITING), callback_(f), timernode_(NULL), data_(data) {}
